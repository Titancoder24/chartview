        ...
        {bullets.map((b, i) => (
          <div key={i}>
            <div className="flex justify-between mb-1.5">
              <span className="text-xs" style={{ color: theme.textSecondary }}>{b.label}</span>
            ...
            <div className="relative h-5 rounded-md overflow-hidden">
              <div className="absolute inset-0 flex">
                <div className="h-full" style={{ width: `${b.ranges[0]}%`, backgroundColor: theme.gridColor }} />
                <div className="h-full" style={{ width: `${b.ranges[1] - b.ranges[0]}%`, backgroundColor: theme.gridColor + '80' }} />
                <div className="h-full" style={{ width: `${b.ranges[2] - b.ranges[1]}%`, backgroundColor: theme.gridColor + '40' }} />
              </div>
