...
export default function BoxPlotComponent() {
  ...
  const svgW = 400, svgH = 200, maxVal = 100, barW = 40;
        ...
        {boxData.map((d, i) => {
          ...
          return (
            <g key={i}>
              ...
              <rect x={x} y={scale(d.q3)} width={barW} height={scale(d.q1) - scale(d.q3)} rx={4} fill={theme.colors[0]} fillOpacity={0.2} stroke={theme.colors[0]} strokeWidth={1.5} />
              <line x1={x} y1={scale(d.median)} x2={x + barW} y2={scale(d.median)} stroke={theme.colors[1]} strokeWidth={2} />
