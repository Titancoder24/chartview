    ...
    <ChartCard title="Completion Rate" subtitle="Gradient ring progress">
      <div className="flex flex-col items-center">
        <svg width="180" height="180" viewBox="0 0 180 180">
          ...
          <circle cx="90" cy="90" r={r} fill="none" stroke="url(#ringGrad2)" strokeWidth="10" strokeLinecap="round" strokeDasharray={circumference} strokeDashoffset={dashOffset} transform="rotate(-90 90 90)" />
