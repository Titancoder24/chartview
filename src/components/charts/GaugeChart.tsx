          ...
          return (
            <div key={i} className="flex flex-col items-center">
              <svg width="90" height="70" viewBox="0 0 90 75">
                ...
                <circle cx="45" cy="45" r={r} fill="none" stroke={color} strokeWidth="7" strokeDasharray={`${arc - offset} ${c}`} strokeLinecap="round" transform="rotate(135 45 45)" style={{ transition: 'stroke-dasharray 1s ease' }} />
